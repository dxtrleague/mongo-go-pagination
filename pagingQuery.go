...
type PagingQuery interface {
	...
	Find(context context.Context) (paginatedData *PaginatedData, err error)
...
func (paging *pagingQuery) Find(context context.Context) (paginatedData *PaginatedData, err error) {
	...
	cursor, err := paging.Collection.Find(context, paging.FilterQuery, opt)
	if err != nil {
		return nil, err
	}
